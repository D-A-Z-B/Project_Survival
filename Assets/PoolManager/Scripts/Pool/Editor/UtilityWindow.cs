...
public class UtilityWindow : EditorWindow
{
    ...
    #region 각 데이터 테이블 모음
    private readonly string _poolDirectory = "Assets/SO/ObjectPool";
    ...
    {
        T table = AssetDatabase.LoadAssetAtPath<T>($"{path}/PoolingItemTable.asset");
        if (table == null)
        {
            table = ScriptableObject.CreateInstance<T>();

            string fileName = AssetDatabase.GenerateUniqueAssetPath($"{path}/PoolingItemTable.asset");
    ...
    private void GenerateEnumFile() {
        ...
        string path = $"{Application.dataPath}/PoolManager/Scripts/Pool/PoolingType.cs";
